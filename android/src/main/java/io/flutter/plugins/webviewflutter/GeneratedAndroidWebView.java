...
public class GeneratedAndroidWebView {
    ...
    public interface WebSettingsHostApi {
        ...
        void setCacheMode(@NonNull Long instanceId, @NonNull Integer model);
        ...
        static void setup(@NonNull BinaryMessenger binaryMessenger, @Nullable WebSettingsHostApi api) {
...

            {
                BasicMessageChannel<Object> channel =
                        new BasicMessageChannel<>(
                                binaryMessenger,
                                "dev.flutter.pigeon.WebSettingsHostApi.setCacheMode",
                                getCodec());
                if (api != null) {
                    channel.setMessageHandler(
                            (message, reply) -> {
                                ...
                                ArrayList<Object> args = (ArrayList<Object>) message;
                                Number instanceIdArg = (Number) args.get(0);
                                Integer modeArg = (Boolean) args.get(1);
                                try {
                                    api.setCacheMode(
                                            (instanceIdArg == null) ? null : instanceIdArg.longValue(), modeArg);
                                    wrapped.add(0, null);
                                } catch (Throwable exception) {
                                    ArrayList<Object> wrappedError = wrapError(exception);
                                    wrapped = wrappedError;
